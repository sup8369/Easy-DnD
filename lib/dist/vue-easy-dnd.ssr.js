...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-5e507fc2_0", { source: ".drop-list[data-v-5e507fc2]>*{transition:transform .2s}.__feedback[data-v-5e507fc2]{display:none}.__drag-image[data-v-5e507fc2]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined })
,inject("data-v-5e507fc2_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-5e507fc2";
  /* module identifier */
  var __vue_module_identifier__$4 = "data-v-5e507fc2";
  /* functional template */
