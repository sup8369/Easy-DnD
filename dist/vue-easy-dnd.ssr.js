...
var DragMixin = /** @class */ (function (_super) {
  ...
  DragMixin = __decorate([vuePropertyDecorator.Component({})], DragMixin);
  return DragMixin;
})(DragAwareMixin);
...
var Drag = /** @class */ (function (_super) {
  ...
  Drag = __decorate([vuePropertyDecorator.Component({})], Drag);
  return Drag;
})(DragMixin);
...
/* module identifier */
var __vue_module_identifier__ = "data-v-fb811e22";
/* functional template */
...
var DropMixin = /** @class */ (function (_super) {
  ...
  Object.defineProperty(DropMixin.prototype, "compatibleMode", {
    get: function () {
      if (this.dragInProgress) {
        return (
          this.mode === "copy" ||
          exports.dnd.sourceListeners.hasOwnProperty(this.mode)
        );
      } else {
        return null;
      }
  ...
  DropMixin = __decorate(
    [vuePropertyDecorator.Component({}), __metadata("design:paramtypes", [])],
    DropMixin
  );
  return DropMixin;
})(DragAwareMixin);
...
var Drop = /** @class */ (function (_super) {
  ...
  Drop = __decorate([vuePropertyDecorator.Component({})], Drop);
  return Drop;
})(DropMixin);
...
/* module identifier */
var __vue_module_identifier__$1 = "data-v-1d9169a9";
/* functional template */
...
var DropMask = /** @class */ (function (_super) {
  ...
  DropMask = __decorate([vuePropertyDecorator.Component({})], DropMask);
  return DropMask;
})(DragAwareMixin);
...
/* module identifier */
var __vue_module_identifier__$2 = "data-v-773ccf08";
/* functional template */
...
var DragFeedback = /** @class */ (function (_super) {
  ...
  DragFeedback = __decorate([vuePropertyDecorator.Component({})], DragFeedback);
  return DragFeedback;
})(vuePropertyDecorator.Vue);
...
/* module identifier */
var __vue_module_identifier__$3 = "data-v-0589f3cb";
/* functional template */
...
var DropList = /** @class */ (function (_super) {
  ...
  DropList.prototype.onDragStart = function (event) {
    if (
      this.candidate(exports.dnd.type, exports.dnd.data, exports.dnd.source)
    ) {
      if (this.reordering) {
  ...
  Object.defineProperty(DropList.prototype, "reordering", {
    get: function () {
      if (exports.dnd.inProgress) {
        return (
          exports.dnd.source.$el.parentElement === this.$el &&
  ...
  __decorate(
    [vuePropertyDecorator.Prop(), __metadata("design:type", Array)],
    DropList.prototype,
    "items",
    void 0
  );
...
/* module identifier */
var __vue_module_identifier__$4 = "data-v-228404f8";
/* functional template */
