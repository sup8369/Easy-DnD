var VueEasyDnD = (function (exports, vue) {
    'use strict';
    ...
    const dnd = vue.reactive(new DnD());
    ...
    function render$3(_ctx, _cache, $props, $setup, $data, $options) {
      return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.tag), {
        ...
        default: vue.withCtx(() => [
          vue.renderSlot(_ctx.$slots, "default", vue.normalizeProps(vue.guardReactiveProps(_ctx.$slots['default'] || {}))),
          (_ctx.dragInitialised)
            ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
                vue.renderSlot(_ctx.$slots, "drag-image")
              ], 512 /* NEED_PATCH */))
            : vue.createCommentVNode("v-if", true)
        ]),
        _: 2 /* DYNAMIC */
      }, [
        vue.renderList($options.dynamicSlots, ([slot, args]) => {
          return {
            name: slot,
            fn: vue.withCtx(() => [
              vue.renderSlot(_ctx.$slots, slot, vue.normalizeProps(vue.guardReactiveProps(args)))
            ])
          }
        })
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.tag), null, vue.createSlots({ _: 2 /* DYNAMIC */ }, [
        vue.renderList(_ctx.$slots, (args, slot) => {
          return {
            name: slot,
            fn: vue.withCtx(() => [
              vue.renderSlot(_ctx.$slots, slot, vue.normalizeProps(vue.guardReactiveProps(args)))
    ...
    exports.Drag = script$4;
    exports.DragAwareMixin = DragAwareMixin;
    exports.DragFeedback = script$1;
    exports.DragImagesManager = DragImagesManager;
    exports.DragMixin = DragMixin;
    exports.Drop = script$3;
    exports.DropList = script;
    exports.DropMask = script$2;
